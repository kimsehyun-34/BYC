...
with open("KakaoTalkChats.txt", encoding='utf-8') as f: #불필요 부분
    total_lines = sum(1 for line in f)
wi=((total_lines)-5)*20
print("불필요 부분:",wi) #불필요 부분
##
...
data,count = fileopen("KakaoTalkChats.txt")
 
print("공백을 제외한 문자수 : ",count_character(data) ) #공백을 제외한 문자수
##
wii=(count_character(data))-wi
